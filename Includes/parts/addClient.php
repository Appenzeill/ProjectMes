  ...
  <form class="mx-auto" style="width: 500px;" action="" method="post">
    ...
    <hr class="bg-secondary">
      ...
      <div class="input-group mb-3">
        ...
        <select class="custom-select" name="bloedgroep" id="bloedgroep">
          <option selected>Kies...</option>
    ...
    <div class="input-group mb-3">
      <div class="input-group-prepend">
        <label class="input-group-text" for="zorgverzekering">Zorgverzekering</label>
      </div>
      <select name="zorgverzekering" class="custom-select" id="zorgverzekering">
        <option selected>Kies...</option>
          <?php
