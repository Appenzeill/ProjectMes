		...
		foreach ($userIds->results() as $userid){
			Database::getInstance()->create(
				...
				[
					...
					'pharmacy' => Input::get('appotheek'),
				]);

		}

		$status = "<div class='alert alert-primary alert-dismissible fade show mx-4 mt-4' role='alert'>Nieuwe appotheek toegevoegd!!
...
<div class="jumbotron bg-dark text-white m-4 p-5">
	<h1 class="display-3 text-center">Registreer appotheek</h1>
	...
	<form class="mx-auto" style="width: 500px;" action="" method="post">
		...
		<h1 class="display-3 text-center pt-5">Gegevens appotheek</h1>
		...
		<div class="form-group">
			<label for="first_name">Naam appotheek</label>
			<input type="text" class="form-control" name="appotheek" id="appotheek" placeholder="Naam appotheek" required>
		</div>
